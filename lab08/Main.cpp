...
// o nazwie Wyjatki. Program nalezy kompilowac z flagami -Wall -g.
...
// (w tym wlasnych wczesniej
// przygotowanych plikow oprocz makefile)

// Rozwiazanie (archiwum Wyjatki.tar.gz zawierajace w folderze dodane pliki, makefile i Main.cpp)
