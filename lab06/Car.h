...
public:
    ...
    */
     ...
     * 
     * @fn UpdateLocation       
     * @brief               metoda aktualizujaca wspolrzedne gps
     * @param float         longitude - dlugosc geograficzna
     * @param float         latitude - szerokosc geograficzna
     * @return Coordinate   koordynat ktory ma 2 wspolrzedne
    */
    Coordinate UpdateLocation(float longitude, float latitude);

    /**
     * 
     * @fn GpsLocationInfo      
     * @brief               metoda wypisujaca informacje o polozeniu GPS
     * @return string       informacja o polozeniu GPS
     * 
    */
    std::string GpsLocationInfo()const;
protected:
